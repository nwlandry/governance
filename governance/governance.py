...
def decision_process(
    opinions, decisions, select_decision, select_group, make_decision, update_opinions
):
    ...
    while len(completed_decisions) < num_decisions:
        ...
        d = select_decision(decisions, completed_decisions, opinions)
        ...
        completed_decisions[d] = make_decision(
            d, g, decisions, opinions, completed_decisions
        )
